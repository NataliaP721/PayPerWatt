...
public class ConnectBluetooth extends AppCompatActivity {
    ...
    /**
     * Refreshes the device list whenever the activiy resumes
     */
    ...
    private void scanAgainButton(){
        ...
        toolBarBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(ConnectBluetooth.this, "Scanning...", Toast.LENGTH_LONG).show();
                refreshDeviceList();
            }
        });
    }
        ...
        listView1.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
                if (controlFlags.monitorConsumption){
                    launch_intent_to_monitor_consumption(mBT_DeviceList.get(position));
                }
                else if (controlFlags.startCharging){
                    launch_intent_to_startCharging(mBT_DeviceList.get(position));
                }
                listView1_adapter.notifyDataSetChanged();
            }
        });
