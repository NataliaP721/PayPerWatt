...
import com.stripe.priceselection.activity.LauncherActivity;
import com.stripe.priceselection.activity.PaymentMultilineActivity;

import java.lang.reflect.Method;
import java.util.ArrayList;
import java.util.Set;

import static com.stripe.priceselection.bluetooth_and_login.Constants.MY_PERMISSIONS_REQUEST_ACCESS_FINE_LOCATION;
...
public class ConnectBluetooth extends AppCompatActivity {
    ...
    private void launch_intent_to_startCharging(BluetoothDevice mBT){
        Intent intent = new Intent(ConnectBluetooth.this, LauncherActivity.class);
